...
import uz.tashkec.repository.JobHistoryRepository;
import uz.tashkec.service.JobHistoryService;
import uz.tashkec.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.tashkec.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
