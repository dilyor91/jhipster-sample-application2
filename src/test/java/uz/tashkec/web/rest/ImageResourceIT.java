...
class ImageResourceIT {
    ...
    private static final Boolean DEFAULT_MAINLY_PHOTO = false;
    private static final Boolean UPDATED_MAINLY_PHOTO = true;
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image()
            ...
            .mainlyPhoto(DEFAULT_MAINLY_PHOTO);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image()
            ...
            .mainlyPhoto(UPDATED_MAINLY_PHOTO);
        return image;
    }
    ...
    void createImage() throws Exception {
        ...
        assertThat(testImage.getOrginalName()).isEqualTo(DEFAULT_ORGINAL_NAME);
        assertThat(testImage.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testImage.getImageData()).isEqualTo(DEFAULT_IMAGE_DATA);
        assertThat(testImage.getMainlyPhoto()).isEqualTo(DEFAULT_MAINLY_PHOTO);
    }
    ...
    void getAllImages() throws Exception {
        ...
        restImageMockMvc
            ...
            .andExpect(jsonPath("$.[*].mainlyPhoto").value(hasItem(DEFAULT_MAINLY_PHOTO.booleanValue())));
    }
    ...
    void getImage() throws Exception {
        ...
        restImageMockMvc
            ...
            .andExpect(jsonPath("$.mainlyPhoto").value(DEFAULT_MAINLY_PHOTO.booleanValue()));
    }
    ...
    void putExistingImage() throws Exception {
        ...
        updatedImage.orginalName(UPDATED_ORGINAL_NAME).name(UPDATED_NAME).imageData(UPDATED_IMAGE_DATA).mainlyPhoto(UPDATED_MAINLY_PHOTO);
        ...
        Image testImage = imageList.get(imageList.size() - 1);
        assertThat(testImage.getOrginalName()).isEqualTo(UPDATED_ORGINAL_NAME);
        assertThat(testImage.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testImage.getImageData()).isEqualTo(UPDATED_IMAGE_DATA);
        assertThat(testImage.getMainlyPhoto()).isEqualTo(UPDATED_MAINLY_PHOTO);
    }
    ...
    void partialUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.name(UPDATED_NAME).imageData(UPDATED_IMAGE_DATA);
