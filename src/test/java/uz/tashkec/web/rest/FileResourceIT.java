...
class FileResourceIT {
    ...
    private static final String DEFAULT_ORGINAL_NAME = "AAAAAAAAAA";
    private static final String UPDATED_ORGINAL_NAME = "BBBBBBBBBB";
    ...
    private static final FileEntity DEFAULT_FILE_ENTITY = FileEntity.STUDYATKOREA;
    private static final FileEntity UPDATED_FILE_ENTITY = FileEntity.INSTITUION;
    ...
    public static File createEntity(EntityManager em) {
        File file = new File()
            .orginalName(DEFAULT_ORGINAL_NAME)
            .fileName(DEFAULT_FILE_NAME)
            .fileSize(DEFAULT_FILE_SIZE)
            .fileFormat(DEFAULT_FILE_FORMAT)
            .filePath(DEFAULT_FILE_PATH)
            .fileEntity(DEFAULT_FILE_ENTITY);
        return file;
    }
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File()
            .orginalName(UPDATED_ORGINAL_NAME)
    ...
    void createFile() throws Exception {
        ...
        assertThat(testFile.getOrginalName()).isEqualTo(DEFAULT_ORGINAL_NAME);
        assertThat(testFile.getFileName()).isEqualTo(DEFAULT_FILE_NAME);
        assertThat(testFile.getFileSize()).isEqualTo(DEFAULT_FILE_SIZE);
        assertThat(testFile.getFileFormat()).isEqualTo(DEFAULT_FILE_FORMAT);
        assertThat(testFile.getFilePath()).isEqualTo(DEFAULT_FILE_PATH);
        assertThat(testFile.getFileEntity()).isEqualTo(DEFAULT_FILE_ENTITY);
    }
    ...
    void getAllFiles() throws Exception {
        ...
        restFileMockMvc
            ...
            .andExpect(jsonPath("$.[*].orginalName").value(hasItem(DEFAULT_ORGINAL_NAME)))
            .andExpect(jsonPath("$.[*].fileName").value(hasItem(DEFAULT_FILE_NAME)))
            .andExpect(jsonPath("$.[*].fileSize").value(hasItem(DEFAULT_FILE_SIZE.intValue())))
            .andExpect(jsonPath("$.[*].fileFormat").value(hasItem(DEFAULT_FILE_FORMAT)))
            .andExpect(jsonPath("$.[*].filePath").value(hasItem(DEFAULT_FILE_PATH)))
            .andExpect(jsonPath("$.[*].fileEntity").value(hasItem(DEFAULT_FILE_ENTITY.toString())));
    }
    ...
    void getFile() throws Exception {
        ...
        restFileMockMvc
            ...
            .andExpect(jsonPath("$.orginalName").value(DEFAULT_ORGINAL_NAME))
            .andExpect(jsonPath("$.fileName").value(DEFAULT_FILE_NAME))
            .andExpect(jsonPath("$.fileSize").value(DEFAULT_FILE_SIZE.intValue()))
            .andExpect(jsonPath("$.fileFormat").value(DEFAULT_FILE_FORMAT))
            .andExpect(jsonPath("$.filePath").value(DEFAULT_FILE_PATH))
            .andExpect(jsonPath("$.fileEntity").value(DEFAULT_FILE_ENTITY.toString()));
    }
    ...
    void putExistingFile() throws Exception {
        ...
        File testFile = fileList.get(fileList.size() - 1);
        assertThat(testFile.getOrginalName()).isEqualTo(UPDATED_ORGINAL_NAME);
        assertThat(testFile.getFileName()).isEqualTo(UPDATED_FILE_NAME);
        assertThat(testFile.getFileSize()).isEqualTo(UPDATED_FILE_SIZE);
        assertThat(testFile.getFileFormat()).isEqualTo(UPDATED_FILE_FORMAT);
        assertThat(testFile.getFilePath()).isEqualTo(UPDATED_FILE_PATH);
        assertThat(testFile.getFileEntity()).isEqualTo(UPDATED_FILE_ENTITY);
    }
    ...
    void partialUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.orginalName(UPDATED_ORGINAL_NAME).fileEntity(UPDATED_FILE_ENTITY);
